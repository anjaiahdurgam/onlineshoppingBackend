...
import com.cab.onlineshoppingbackends.utile.FileUploadUtility;
import com.cab.onlineshoppingbackends.validator.ProductValidator;
...
public class ManagementController {
	...
	public String handleProductSubmission(@Valid @ModelAttribute("product") Product mProduct, BindingResult results,
		...
		if (mProduct.getId() == 0) {
			...
			iproductDAO.add(mProduct);
		} else {
			// update the product if id is not 0
			iproductDAO.update(mProduct);
		}
	...
	public ModelAndView showEditProduct(@PathVariable int id) {
		...
		Product nProduct = iproductDAO.get(id);
		// set theproduct fetch from database
		mv.addObject("product", nProduct);
	...
	public String handleProductActivation(@PathVariable int id) {
		...
		product.setActive(!product.isActive()); // updating the product
