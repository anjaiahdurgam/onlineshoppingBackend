			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<sf:form class="form-horizontal" modelAttribute="product"
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="uniteprice">Enter
								Unit Price: </label>
							<div class="col-md-8">
								<sf:input type="number" path="uniteprice" id="uniteprice"
									placeholder="Unit Price In &#8377;" class="form-control" />
								<sf:errors path="uniteprice" cssClass="help-block" element="em" />
							</div>
						</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<!-- Category Form    imp     modelAttribute="category" name same as ModelAttribute name in controller class-->
